...
| planning | dual-engine EVALUATE | a pre-mortem: Claude writes the post-mortems of the recommended approach, Codex argues for the alternative, both tested against each approach's kill criteria | surviving failure modes become risks and build-plan input; an evidence-backed dissent changes or hedges the recommendation |
